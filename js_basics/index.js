...
const firstName = "Joy"
const lastName = "Wanjiru"
const StuternTrack = "Backend"
const skills = ["HTML", "CSS", "JavaScript", "Python"]
const favouriteColor = "black"
const yearofIndependence = 1963
console.log(`My name is  ${firstName} ${lastName}. I am currently specializing in ${StuternTrack}. I am proficient in ${skills}. I love ${favouriteColor}. Our country gained independence in ${yearofIndependence}` )